                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <section class="text-gray-600 body-font">
                        ...
                        <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                            <input type="text" name="search" v-model="search" class="mb-2 mr-1  border py-2 px-6 rounded">
                            <button class="mb-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"
                        @click="searchCustomers">検索</button>
                            <Link as="button" :href="route('customers.create')" class="flex ml-auto mb-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">顧客登録
                            </Link>
                          </div>
                              ...
                              <tbody>
                                  <tr v-for="customer in customers.data" :key="customer.id">
                                        <td class="border-t-2 border-b-2 border-gray-200 px-4 py-3">
                                            <Link class="text-blue-500" :href="route('customers.show',{customer:customer})">{{ customer.id }}</Link>
                                        </td>
