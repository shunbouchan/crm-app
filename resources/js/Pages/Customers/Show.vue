                    ...
                    <section class="text-gray-600 body-font relative">
                       <div class="container px-5 py-8 mx-auto">
                         <div class="lg:w-1/2 md:w-2/3 mx-auto">
                           ...
                           <div class="p-2 w-full">
                            <Link as="button" :href="route('customers.edit',{customer:customer.id})" class="flex ml-auto mb-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">編集</Link>
                        </div>
                        <div class="p-2 w-full">
                            <button @click="deleteConfirm(customer.id)" class="flex ml-auto mb-2 text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">削除</button>
                        </div>
                        </div>
                    </div>
                   </section>
